	...
	<div id="inner_full">
		...
		<div id="body">
			...
			<table align="center">
				...
				<tr>
					<td align="right"><input type="submit" name="sub" value="Login" style="width:70px; height:30px; border-radius:5px;"></td>
				</tr>
			</table>
			</form>
			<?php
		...
		<div id="footer"><h4 align="center">Blood Bank Management System</h4></div>
	</div>
</div>
</body>
